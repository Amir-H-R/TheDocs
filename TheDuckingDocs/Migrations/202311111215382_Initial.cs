namespace TheDuckingDocs.Migrations
{
    ...
    public partial class Initial : DbMigration
    {
                ...
                c => new
                    {
                        ...
                        PersonAddress_AddressId = c.Int(),
                    })
                .PrimaryKey(t => t.PersonId)
                .ForeignKey("dbo.Addresses", t => t.PersonAddress_AddressId)
                .Index(t => t.PersonAddress_AddressId);
        ...
        public override void Down()
        {
            ...
            DropForeignKey("dbo.People", "PersonAddress_AddressId", "dbo.Addresses");
            ...
            DropIndex("dbo.People", new[] { "PersonAddress_AddressId" });
